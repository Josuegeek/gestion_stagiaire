        ...
        <div class="main">
            ...
            <div class="details">
                <form class="form-card" action="<?php
                                                if ($stageExists) echo "./enginePhp/edit.php";
                                                else echo "./enginePhp/insertion.php" ?>" method="post">
                    ...
                    <div class="inputs-container">
                        ...
                        <div class="input-div">
                            <div>
                                ...
                                <input id="lieu-naissance" name="lieu-naissance" type="text" placeholder="Ex:Kinshasa" required <?php
                                                                                                                                if ($stageExists) echo "value=\"$lieu_naiss\"" ?>>
                            </div>
                            <div>
                                <label for="date-naissance">Date de naissance :</label>
                                <input id="date-naissance" name="date-naissance" type="date" required <?php
                        ...
                        <div class="input-div">
                            <div>
                                ...
                                <input id="prov-origin" name="prov-origin" type="text" required <?php
                                                                                                if ($stageExists) echo "value=\"$prov_origin\"" ?>>
                            </div>
                            <div>
                                <label for="district-origin">District d'origine :</label>
                                <input id="district-origin" name="district-origin" type="text" required <?php
                                                                                                        if ($stageExists) echo "value=\"$district\"" ?>>
                            </div>

                            <div>
                                <label for="village-origin">Village d'origine :</label>
                                <input id="village-origin" name="village-origin" type="text" required <?php
                        ...
                        <div class="input-div">
                            <div>
                                ...
                                <input id="adresse" name="adresse" type="text" placeholder="45,av. street C/Lemba Q/Salongo" required <?php
                                                                                                                                        if ($stageExists) echo "value=\"$adresse\"" ?>>
                            </div>
                            <div>
                                <label for="tel">Téléphone :</label>
                                <input id="tel" name="tel" type="tel" placeholder="+243 81456789" required <?php
                    ...
                    <div id="section-student" class="inputs-container">
                        ...
                        <div class="input-div">
                            <div>
                                ...
                                <input id="fac" name="fac" type="text" placeholder="Ex : Sciences" required <?php
                                                                                                            if ($stageExists) echo "value=\"$fac\"" ?>>
                            </div>
                            <div>
                                <label for="departement">Departement :</label>
                                <input id="departement" name="departement" type="text" placeholder="Chimie" required <?php
                        ...
                        <div class="input-div">
                            <div>
                                ...
                                <input id="supervision" name="supervision" type="text" placeholder="Prof. Djungu" required <?php
                    ...
                    <button id="submit" class="btn"><?php if ($stageExists) echo "Modifier";
                                                    else echo "Enregistrer" ?></button>
